...
\end{center}
\caption{Scatter plot of $p$ value vs $\rho$ value. $p$ is goodness-fit of test for power-law model, if $p \geq 0.1$ power-law model is good model for data set. $\rho$ is significance test for nested hypothesis.  } 
