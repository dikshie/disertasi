...
if $\rho \leq 0.1$ there is significant difference between the likelihood of the data ynder the two hypotheses being compared.
...
\caption{CDF plot of $\rho$ value of log-likehood ratio test for power-law v.s 
         ...
         Since $87\%$ of $\rho$ values are more than $0.1$, the sign of log-likehood ratio is not good indicator and the test does not favor either model over the other. 
...
\caption{Scatter plot $p$ values v.s log-likelihood
         ...
         In this figure, we show the log-likehood ratio (LR) values for $\rho \le 0.1$.
         Since the LR values are negative, the alternative distribution not better than power-law model.} 
...
\caption{CDF plot of $\rho$ value of log-likehood ratio test for power-law v.s exponential.
        ...
        Since $94.5\%$ of $\rho$ values are more than $0.1$, the sign of log-likehood ratio is not good indicator and the test does not favor either model over the other.  
		} 
