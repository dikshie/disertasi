...
\begin{figure}[tb]
\begin{center}
\includegraphics[scale=0.5]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/pex_2.eps}
\end{center}
...
\begin{figure}[!t]
\begin{center}
\includegraphics[scale=0.8]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/new/cdf-num.eps}
\end{center}
...
\begin{figure}[!tb]
\begin{center}
\includegraphics[scale=0.8]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/output_2.eps}
\end{center}
...
\begin{figure}[!tb]
\begin{center}
\includegraphics[scale=0.8]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/new/aggregate-p-cdf.eps}
\end{center}
...
\centering
\includegraphics[width=2.6in]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/new/gabung-korelasi-p-rho.eps}
\end{minipage}%
\hfill%
\begin{minipage}[b]{.45\linewidth}
\centering
\centering
\includegraphics[width=2.6in]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/new/gabung-korelasi-p-rho-4region.eps}
\end{minipage}\\[-7pt]
...
\begin{minipage}[b]{.45\linewidth}
\centering
\includegraphics[width=2.6in]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/non-nested/aggregate-p-cdf-non-nested-lognorm.eps}
\end{minipage}%
\hfill%
\begin{minipage}[b]{.45\linewidth}
\centering
\centering
\includegraphics[width=2.6in]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/non-nested/lr-p-lognorm.eps}
\end{minipage}\\[-7pt]
\begin{minipage}[t]{.45\linewidth}
...
\begin{minipage}[b]{.45\linewidth}
\centering
\includegraphics[width=2.6in]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/non-nested/aggregate-p-cdf-non-nestedi-exp.eps}
\end{minipage}%
\hfill%
\begin{minipage}[b]{.45\linewidth}
\centering
\centering
\includegraphics[width=2.6in]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/non-nested/lr-pi-exp.eps}
\end{minipage}\\[-7pt]
\begin{minipage}[t]{.45\linewidth}
...
\begin{figure}[!tb] 
\begin{center}
\includegraphics[scale=0.8]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/graphs/new/cdf-clustering.eps}
\end{center}
...
\begin{figure}[!tb]
\begin{center}
\includegraphics[scale=0.8]{../../../papers/IEEE-P2P/tex/IEICE/jurnal/netscicom-graphs/simula.eps}
\end{center}
