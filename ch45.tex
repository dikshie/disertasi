...
The objective of estimating the Internet VoD popularity phase is to determine whether a video is before-peak, at-peak popularity phase, or after-peak.
...
The datasets consist of the measurement of 29000 videos view count and the time when videos are uploaded, during a period of 36 weeks.
...
Figure \ref{fig:timetopeak} shows Borghol et al., \cite{Borghol:2011:CMP:2039452.2039717} work that around three-quarters of the videos peak within the first six weeks since their upload. 
...
A simple example of determining the video popularity phase is shown in fig.\ref{fig:viewratedistexample} and \ref{fig:viewratedistexamplered}.
In fig.~\ref{fig:viewratedistexample} we have view rate (y-axis) and relative week to peak (x-axis).
We transform these numbers by adding week number and make it as x-axis, view rate  as y-axis, and relative week to peak as z-axis fig.~\ref{fig:viewratedistexample}.
...
$z(t)$ is proportion of view count that we ge from Youtube datasets.  
