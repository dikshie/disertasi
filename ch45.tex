...
However, in PROP the difference between very popular videos and unpopular video is very difficult to differentiate. 
We will explain in sec.\ref{peercachingstrategy} how we can cope with this situation.
For this work, we will take Youtube as an example of an Internet VoD service model.
...
Still from the same time to peak distribution $75\%$ of video reach peak within six weeks, and beyond six week the distribution is considered uniform, it means there are not much additional view count. 
...
% Finally, we have a catalog that consists of: video-id, time when a video is uploaded, final view count, and video size.
...
% We choose four weeks based on probability from time-to-peak distribution that half of videos are already reach peak within 4 weeks.
